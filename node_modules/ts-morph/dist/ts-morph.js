...
class TypeGuards {
    ...
    static isExpression(node) {
        switch (node.getKind()) {
            ...
            case common.SyntaxKind.NeverKeyword:
...
TypeGuards.isAnyKeyword = TypeGuards.is(common.SyntaxKind.AnyKeyword);
TypeGuards.isArrayBindingPattern = TypeGuards.is(common.SyntaxKind.ArrayBindingPattern);
TypeGuards.isArrayLiteralExpression = TypeGuards.is(common.SyntaxKind.ArrayLiteralExpression);
TypeGuards.isArrowFunction = TypeGuards.is(common.SyntaxKind.ArrowFunction);
TypeGuards.isAsExpression = TypeGuards.is(common.SyntaxKind.AsExpression);
TypeGuards.isAwaitExpression = TypeGuards.is(common.SyntaxKind.AwaitExpression);
TypeGuards.isBinaryExpression = TypeGuards.is(common.SyntaxKind.BinaryExpression);
TypeGuards.isBindingElement = TypeGuards.is(common.SyntaxKind.BindingElement);
TypeGuards.isBlock = TypeGuards.is(common.SyntaxKind.Block);
TypeGuards.isBooleanKeyword = TypeGuards.is(common.SyntaxKind.BooleanKeyword);
TypeGuards.isBreakStatement = TypeGuards.is(common.SyntaxKind.BreakStatement);
TypeGuards.isCallExpression = TypeGuards.is(common.SyntaxKind.CallExpression);
TypeGuards.isCaseBlock = TypeGuards.is(common.SyntaxKind.CaseBlock);
TypeGuards.isCaseClause = TypeGuards.is(common.SyntaxKind.CaseClause);
TypeGuards.isCatchClause = TypeGuards.is(common.SyntaxKind.CatchClause);
TypeGuards.isClassDeclaration = TypeGuards.is(common.SyntaxKind.ClassDeclaration);
TypeGuards.isClassExpression = TypeGuards.is(common.SyntaxKind.ClassExpression);
TypeGuards.isCommaListExpression = TypeGuards.is(common.SyntaxKind.CommaListExpression);
TypeGuards.isComputedPropertyName = TypeGuards.is(common.SyntaxKind.ComputedPropertyName);
TypeGuards.isConditionalExpression = TypeGuards.is(common.SyntaxKind.ConditionalExpression);
TypeGuards.isContinueStatement = TypeGuards.is(common.SyntaxKind.ContinueStatement);
TypeGuards.isDebuggerStatement = TypeGuards.is(common.SyntaxKind.DebuggerStatement);
TypeGuards.isDecorator = TypeGuards.is(common.SyntaxKind.Decorator);
TypeGuards.isDefaultClause = TypeGuards.is(common.SyntaxKind.DefaultClause);
TypeGuards.isDeleteExpression = TypeGuards.is(common.SyntaxKind.DeleteExpression);
TypeGuards.isDoStatement = TypeGuards.is(common.SyntaxKind.DoStatement);
TypeGuards.isElementAccessExpression = TypeGuards.is(common.SyntaxKind.ElementAccessExpression);
TypeGuards.isEmptyStatement = TypeGuards.is(common.SyntaxKind.EmptyStatement);
TypeGuards.isEnumDeclaration = TypeGuards.is(common.SyntaxKind.EnumDeclaration);
TypeGuards.isEnumMember = TypeGuards.is(common.SyntaxKind.EnumMember);
TypeGuards.isExportAssignment = TypeGuards.is(common.SyntaxKind.ExportAssignment);
TypeGuards.isExportDeclaration = TypeGuards.is(common.SyntaxKind.ExportDeclaration);
TypeGuards.isExportSpecifier = TypeGuards.is(common.SyntaxKind.ExportSpecifier);
TypeGuards.isExpressionStatement = TypeGuards.is(common.SyntaxKind.ExpressionStatement);
TypeGuards.isExpressionWithTypeArguments = TypeGuards.is(common.SyntaxKind.ExpressionWithTypeArguments);
TypeGuards.isExternalModuleReference = TypeGuards.is(common.SyntaxKind.ExternalModuleReference);
TypeGuards.isFalseKeyword = TypeGuards.is(common.SyntaxKind.FalseKeyword);
TypeGuards.isForInStatement = TypeGuards.is(common.SyntaxKind.ForInStatement);
TypeGuards.isForOfStatement = TypeGuards.is(common.SyntaxKind.ForOfStatement);
TypeGuards.isForStatement = TypeGuards.is(common.SyntaxKind.ForStatement);
TypeGuards.isFunctionDeclaration = TypeGuards.is(common.SyntaxKind.FunctionDeclaration);
TypeGuards.isFunctionExpression = TypeGuards.is(common.SyntaxKind.FunctionExpression);
TypeGuards.isHeritageClause = TypeGuards.is(common.SyntaxKind.HeritageClause);
TypeGuards.isIdentifier = TypeGuards.is(common.SyntaxKind.Identifier);
TypeGuards.isIfStatement = TypeGuards.is(common.SyntaxKind.IfStatement);
TypeGuards.isImportClause = TypeGuards.is(common.SyntaxKind.ImportClause);
TypeGuards.isImportDeclaration = TypeGuards.is(common.SyntaxKind.ImportDeclaration);
TypeGuards.isImportEqualsDeclaration = TypeGuards.is(common.SyntaxKind.ImportEqualsDeclaration);
TypeGuards.isImportSpecifier = TypeGuards.is(common.SyntaxKind.ImportSpecifier);
TypeGuards.isInferKeyword = TypeGuards.is(common.SyntaxKind.InferKeyword);
TypeGuards.isInterfaceDeclaration = TypeGuards.is(common.SyntaxKind.InterfaceDeclaration);
TypeGuards.isJSDocAugmentsTag = TypeGuards.is(common.SyntaxKind.JSDocAugmentsTag);
TypeGuards.isJSDocClassTag = TypeGuards.is(common.SyntaxKind.JSDocClassTag);
TypeGuards.isJSDocFunctionType = TypeGuards.is(common.SyntaxKind.JSDocFunctionType);
TypeGuards.isJSDocParameterTag = TypeGuards.is(common.SyntaxKind.JSDocParameterTag);
TypeGuards.isJSDocPropertyTag = TypeGuards.is(common.SyntaxKind.JSDocPropertyTag);
TypeGuards.isJSDocReturnTag = TypeGuards.is(common.SyntaxKind.JSDocReturnTag);
TypeGuards.isJSDocSignature = TypeGuards.is(common.SyntaxKind.JSDocSignature);
TypeGuards.isJSDocTypeExpression = TypeGuards.is(common.SyntaxKind.JSDocTypeExpression);
TypeGuards.isJSDocTypeTag = TypeGuards.is(common.SyntaxKind.JSDocTypeTag);
TypeGuards.isJSDocTypedefTag = TypeGuards.is(common.SyntaxKind.JSDocTypedefTag);
TypeGuards.isJsxAttribute = TypeGuards.is(common.SyntaxKind.JsxAttribute);
TypeGuards.isJsxClosingElement = TypeGuards.is(common.SyntaxKind.JsxClosingElement);
TypeGuards.isJsxClosingFragment = TypeGuards.is(common.SyntaxKind.JsxClosingFragment);
TypeGuards.isJsxElement = TypeGuards.is(common.SyntaxKind.JsxElement);
TypeGuards.isJsxExpression = TypeGuards.is(common.SyntaxKind.JsxExpression);
TypeGuards.isJsxFragment = TypeGuards.is(common.SyntaxKind.JsxFragment);
TypeGuards.isJsxOpeningElement = TypeGuards.is(common.SyntaxKind.JsxOpeningElement);
TypeGuards.isJsxOpeningFragment = TypeGuards.is(common.SyntaxKind.JsxOpeningFragment);
TypeGuards.isJsxSelfClosingElement = TypeGuards.is(common.SyntaxKind.JsxSelfClosingElement);
TypeGuards.isJsxSpreadAttribute = TypeGuards.is(common.SyntaxKind.JsxSpreadAttribute);
TypeGuards.isJsxText = TypeGuards.is(common.SyntaxKind.JsxText);
TypeGuards.isLabeledStatement = TypeGuards.is(common.SyntaxKind.LabeledStatement);
TypeGuards.isMetaProperty = TypeGuards.is(common.SyntaxKind.MetaProperty);
TypeGuards.isMethodDeclaration = TypeGuards.is(common.SyntaxKind.MethodDeclaration);
TypeGuards.isMethodSignature = TypeGuards.is(common.SyntaxKind.MethodSignature);
TypeGuards.isModuleBlock = TypeGuards.is(common.SyntaxKind.ModuleBlock);
TypeGuards.isNamedExports = TypeGuards.is(common.SyntaxKind.NamedExports);
TypeGuards.isNamedImports = TypeGuards.is(common.SyntaxKind.NamedImports);
TypeGuards.isNamespaceImport = TypeGuards.is(common.SyntaxKind.NamespaceImport);
TypeGuards.isNeverKeyword = TypeGuards.is(common.SyntaxKind.NeverKeyword);
TypeGuards.isNewExpression = TypeGuards.is(common.SyntaxKind.NewExpression);
TypeGuards.isNoSubstitutionTemplateLiteral = TypeGuards.is(common.SyntaxKind.NoSubstitutionTemplateLiteral);
TypeGuards.isNonNullExpression = TypeGuards.is(common.SyntaxKind.NonNullExpression);
TypeGuards.isNotEmittedStatement = TypeGuards.is(common.SyntaxKind.NotEmittedStatement);
TypeGuards.isNumberKeyword = TypeGuards.is(common.SyntaxKind.NumberKeyword);
TypeGuards.isNumericLiteral = TypeGuards.is(common.SyntaxKind.NumericLiteral);
TypeGuards.isObjectBindingPattern = TypeGuards.is(common.SyntaxKind.ObjectBindingPattern);
TypeGuards.isObjectKeyword = TypeGuards.is(common.SyntaxKind.ObjectKeyword);
TypeGuards.isObjectLiteralExpression = TypeGuards.is(common.SyntaxKind.ObjectLiteralExpression);
TypeGuards.isOmittedExpression = TypeGuards.is(common.SyntaxKind.OmittedExpression);
TypeGuards.isParenthesizedExpression = TypeGuards.is(common.SyntaxKind.ParenthesizedExpression);
TypeGuards.isPartiallyEmittedExpression = TypeGuards.is(common.SyntaxKind.PartiallyEmittedExpression);
TypeGuards.isPostfixUnaryExpression = TypeGuards.is(common.SyntaxKind.PostfixUnaryExpression);
TypeGuards.isPrefixUnaryExpression = TypeGuards.is(common.SyntaxKind.PrefixUnaryExpression);
TypeGuards.isPropertyAccessExpression = TypeGuards.is(common.SyntaxKind.PropertyAccessExpression);
TypeGuards.isPropertyAssignment = TypeGuards.is(common.SyntaxKind.PropertyAssignment);
TypeGuards.isPropertyDeclaration = TypeGuards.is(common.SyntaxKind.PropertyDeclaration);
TypeGuards.isPropertySignature = TypeGuards.is(common.SyntaxKind.PropertySignature);
TypeGuards.isQualifiedName = TypeGuards.is(common.SyntaxKind.QualifiedName);
TypeGuards.isRegularExpressionLiteral = TypeGuards.is(common.SyntaxKind.RegularExpressionLiteral);
TypeGuards.isReturnStatement = TypeGuards.is(common.SyntaxKind.ReturnStatement);
TypeGuards.isSemicolonToken = TypeGuards.is(common.SyntaxKind.SemicolonToken);
TypeGuards.isShorthandPropertyAssignment = TypeGuards.is(common.SyntaxKind.ShorthandPropertyAssignment);
TypeGuards.isSourceFile = TypeGuards.is(common.SyntaxKind.SourceFile);
TypeGuards.isSpreadAssignment = TypeGuards.is(common.SyntaxKind.SpreadAssignment);
TypeGuards.isSpreadElement = TypeGuards.is(common.SyntaxKind.SpreadElement);
TypeGuards.isStringKeyword = TypeGuards.is(common.SyntaxKind.StringKeyword);
TypeGuards.isStringLiteral = TypeGuards.is(common.SyntaxKind.StringLiteral);
TypeGuards.isSwitchStatement = TypeGuards.is(common.SyntaxKind.SwitchStatement);
TypeGuards.isSymbolKeyword = TypeGuards.is(common.SyntaxKind.SymbolKeyword);
TypeGuards.isSyntaxList = TypeGuards.is(common.SyntaxKind.SyntaxList);
TypeGuards.isTaggedTemplateExpression = TypeGuards.is(common.SyntaxKind.TaggedTemplateExpression);
TypeGuards.isTemplateExpression = TypeGuards.is(common.SyntaxKind.TemplateExpression);
TypeGuards.isTemplateHead = TypeGuards.is(common.SyntaxKind.TemplateHead);
TypeGuards.isTemplateMiddle = TypeGuards.is(common.SyntaxKind.TemplateMiddle);
TypeGuards.isTemplateSpan = TypeGuards.is(common.SyntaxKind.TemplateSpan);
TypeGuards.isTemplateTail = TypeGuards.is(common.SyntaxKind.TemplateTail);
TypeGuards.isThrowStatement = TypeGuards.is(common.SyntaxKind.ThrowStatement);
TypeGuards.isTrueKeyword = TypeGuards.is(common.SyntaxKind.TrueKeyword);
TypeGuards.isTryStatement = TypeGuards.is(common.SyntaxKind.TryStatement);
TypeGuards.isTypeAliasDeclaration = TypeGuards.is(common.SyntaxKind.TypeAliasDeclaration);
TypeGuards.isTypeOfExpression = TypeGuards.is(common.SyntaxKind.TypeOfExpression);
TypeGuards.isUndefinedKeyword = TypeGuards.is(common.SyntaxKind.UndefinedKeyword);
TypeGuards.isVariableDeclaration = TypeGuards.is(common.SyntaxKind.VariableDeclaration);
TypeGuards.isVariableDeclarationList = TypeGuards.is(common.SyntaxKind.VariableDeclarationList);
TypeGuards.isVariableStatement = TypeGuards.is(common.SyntaxKind.VariableStatement);
TypeGuards.isVoidExpression = TypeGuards.is(common.SyntaxKind.VoidExpression);
TypeGuards.isWhileStatement = TypeGuards.is(common.SyntaxKind.WhileStatement);
TypeGuards.isWithStatement = TypeGuards.is(common.SyntaxKind.WithStatement);
TypeGuards.isYieldExpression = TypeGuards.is(common.SyntaxKind.YieldExpression);
...
function printNode(node, sourceFileOrOptions, secondOverloadOptions) {
    ...
    const printer = common.ts.createPrinter({
        newLine: options.newLineKind == null ? common.NewLineKind.LineFeed : options.newLineKind,
        removeComments: options.removeComments || false
    });
    if (sourceFile == null)
        return printer.printFile(node);
    else
        return printer.printNode(options.emitHint == null ? common.EmitHint.Unspecified : options.emitHint, node, sourceFile);
    function getSourceFile() {
        ...
        function getScriptKind() {
            return options.scriptKind == null ? common.ScriptKind.TSX : options.scriptKind;
        }
...
function doManipulation(sourceFile, textManipulator, nodeHandler, newFilePath) {
    ...
    try {
        ...
        if (diagnostics.length > 0) {
            throw new common.errors.InvalidOperationError("Manipulation error: " + "A syntax error was inserted." + "\n\n"
                + sourceFile._context.project.formatDiagnosticsWithColorAndContext(diagnostics, { newLineChar: "\n" })
                + "\n" + errorDetails);
        }
        throw new common.errors.InvalidOperationError("Manipulation error: " + errorDetails);
    }
}
...
function isLastNonWhitespaceCharCloseBrace(writer) {
    return writer.iterateLastChars(char => {
        if (char === "}")
            return true;
        else if (common.StringUtils.isWhitespaceChar(char))
            return undefined;
        else
            return false;
    }) || false;
...
function getValidRange(thisNode) {
    ...
    const openBrace = TypeGuards.isSourceFile(rangeNode) ? undefined : rangeNode.getPreviousSiblingIfKind(common.SyntaxKind.OpenBraceToken);
...
const createBase$2 = (ctor) => TypeArgumentedNode(ArgumentedNode(LeftHandSideExpressionedNode(ctor)));
...
const createBase$3 = (ctor) => TypeArgumentedNode(ArgumentedNode(LeftHandSideExpressionedNode(ctor)));
const NewExpressionBase = createBase$3(PrimaryExpression);
...
const createBase$4 = (ctor) => InitializerExpressionGetableNode(QuestionTokenableNode(PropertyNamedNode(ctor)));
const PropertyAssignmentBase = createBase$4(ObjectLiteralElement);
...
const createBase$5 = (ctor) => InitializerExpressionGetableNode(QuestionTokenableNode(NamedNode(ctor)));
const ShorthandPropertyAssignmentBase = createBase$5(ObjectLiteralElement);
...
const createBase$6 = (ctor) => NamedNode(LeftHandSideExpressionedNode(ctor));
const PropertyAccessExpressionBase = createBase$6(MemberExpression);
...
const createBase$7 = (ctor) => TypedNode(UnaryExpressionedNode(ctor));
const TypeAssertionBase = createBase$7(UnaryExpression);
...
const createBase$8 = (ctor) => TextInsertableNode(StatementedNode(ctor));
const BlockBase = createBase$8(Statement);
...
const CaseClauseBase = createBase$9(Node);
...
const DefaultClauseBase = createBase$a(Node);
...
const createBase$b = (ctor) => JSDocableNode(NamedNode(ctor));
const ImportEqualsDeclarationBase = createBase$b(Statement);
...
const createBase$c = (ctor) => ModuledNode(UnwrappableNode(TextInsertableNode(BodiedNode(NamespaceChildableNode(StatementedNode(JSDocableNode(AmbientableNode(ExportableNode(ModifierableNode(NamedNode(ctor)))))))))));
const NamespaceDeclarationBase = createBase$c(Statement);
class NamespaceDeclaration extends NamespaceDeclarationBase {
    ...
    getDeclarationKindKeyword() {
        const keyword = this.getFirstChild(child => child.getKind() === common.SyntaxKind.NamespaceKeyword
...
class SourceFile extends SourceFileBase {
    ...
    getDirectoryPath() {
        return common.FileUtils.getDirPath(this.compilerNode.fileName);
    }
    getFullText() {
        return this.compilerNode.text;
    }
...
const createBase$d = (ctor) => NamespaceChildableNode(JSDocableNode(AmbientableNode(ExportableNode(ModifierableNode(ctor)))));
const VariableStatementBase = createBase$d(Statement);
...
const createBase$e = (ctor) => TextInsertableNode(BodiedNode(AsyncableNode(FunctionLikeDeclaration(ctor))));
const ArrowFunctionBase = createBase$e(Expression);
...
const createBase$f = (ctor) => UnwrappableNode(TextInsertableNode(OverloadableNode(BodyableNode(AsyncableNode(GeneratorableNode(AmbientableNode(ExportableNode(FunctionLikeDeclaration(NamespaceChildableNode(NameableNode(ctor)))))))))));
const FunctionDeclarationBase = createBase$f(Statement);
...
const createBase$g = (ctor) => JSDocableNode(TextInsertableNode(BodiedNode(AsyncableNode(GeneratorableNode(StatementedNode(TypeParameteredNode(SignaturedDeclaration(ModifierableNode(NameableNode(ctor))))))))));
const FunctionExpressionBase = createBase$g(PrimaryExpression);
class FunctionExpression extends FunctionExpressionBase {
}

const createBase$h = (ctor) => QuestionTokenableNode(DecoratableNode(ScopeableNode(ReadonlyableNode(ModifierableNode(TypedNode(InitializerExpressionableNode(BindingNamedNode(ctor))))))));
const ParameterDeclarationBase = createBase$h(Node);
...
const createBase$i = (ctor) => ChildOrderableNode(TextInsertableNode(OverloadableNode(BodyableNode(DecoratableNode(AbstractableNode(ScopedNode(QuestionTokenableNode(StaticableNode(AsyncableNode(GeneratorableNode(FunctionLikeDeclaration(PropertyNamedNode(ctor)))))))))))));
const MethodDeclarationBase = createBase$i(ClassElement);
...
const createBase$j = (ctor) => NamespaceChildableNode(AmbientableNode(ExportableNode(ClassLikeDeclarationBase(ctor))));
...
const createBase$k = (ctor) => ChildOrderableNode(TextInsertableNode(OverloadableNode(ScopedNode(FunctionLikeDeclaration(BodyableNode(ctor))))));
const ConstructorDeclarationBase = createBase$k(ClassElement);
...
const createBase$l = (ctor) => ChildOrderableNode(TextInsertableNode(DecoratableNode(AbstractableNode(ScopedNode(StaticableNode(FunctionLikeDeclaration(BodyableNode(PropertyNamedNode(ctor)))))))));
const GetAccessorDeclarationBase = createBase$l(ClassElement);
...
const createBase$m = (ctor) => ChildOrderableNode(DecoratableNode(AbstractableNode(ScopedNode(StaticableNode(JSDocableNode(ReadonlyableNode(ExclamationTokenableNode(QuestionTokenableNode(InitializerExpressionableNode(TypedNode(PropertyNamedNode(ModifierableNode(ctor)))))))))))));
const PropertyDeclarationBase = createBase$m(ClassElement);
...
const createBase$n = (ctor) => ChildOrderableNode(TextInsertableNode(DecoratableNode(AbstractableNode(ScopedNode(StaticableNode(FunctionLikeDeclaration(BodyableNode(PropertyNamedNode(ctor)))))))));
const SetAccessorDeclarationBase = createBase$n(ClassElement);
...
const createBase$o = (ctor) => TypeParameteredNode(TypedNode(JSDocableNode(AmbientableNode(ExportableNode(ModifierableNode(NamedNode(ctor)))))));
const TypeAliasDeclarationBase = createBase$o(Statement);
...
const createBase$p = (ctor) => TextInsertableNode(NamespaceChildableNode(JSDocableNode(AmbientableNode(ExportableNode(ModifierableNode(NamedNode(ctor)))))));
const EnumDeclarationBase = createBase$p(Statement);
...
const createBase$q = (ctor) => JSDocableNode(InitializerExpressionableNode(PropertyNamedNode(ctor)));
const EnumMemberBase = createBase$q(Node);
...
const createBase$r = (ctor) => TypeParameteredNode(ChildOrderableNode(JSDocableNode(SignaturedDeclaration(ctor))));
const CallSignatureDeclarationBase = createBase$r(TypeElement);
...
const ConstructSignatureDeclarationBase = createBase$s(TypeElement);
...
const createBase$t = (ctor) => ReturnTypedNode(ChildOrderableNode(JSDocableNode(ReadonlyableNode(ModifierableNode(ctor)))));
const IndexSignatureDeclarationBase = createBase$t(TypeElement);
...
const createBase$u = (ctor) => TypeElementMemberedNode(TextInsertableNode(ExtendsClauseableNode(HeritageClauseableNode(TypeParameteredNode(JSDocableNode(AmbientableNode(NamespaceChildableNode(ExportableNode(ModifierableNode(NamedNode(ctor)))))))))));
const InterfaceDeclarationBase = createBase$u(Statement);
...
const createBase$v = (ctor) => ChildOrderableNode(JSDocableNode(QuestionTokenableNode(TypeParameteredNode(SignaturedDeclaration(PropertyNamedNode(ctor))))));
const MethodSignatureBase = createBase$v(TypeElement);
...
const createBase$w = (ctor) => ChildOrderableNode(JSDocableNode(ReadonlyableNode(QuestionTokenableNode(InitializerExpressionableNode(TypedNode(PropertyNamedNode(ModifierableNode(ctor))))))));
const PropertySignatureBase = createBase$w(TypeElement);
...
const createBase$x = (ctor) => JsxTagNamedNode(ctor);
const JsxClosingElementBase = createBase$x(Node);
...
const createBase$y = (ctor) => JsxAttributedNode(JsxTagNamedNode(ctor));
const JsxOpeningElementBase = createBase$y(Expression);
...
const JsxSelfClosingElementBase = createBase$z(PrimaryExpression);
...
const createBase$A = (ctor) => ExportGetableNode(ExclamationTokenableNode(TypedNode(InitializerExpressionableNode(BindingNamedNode(ctor)))));
const VariableDeclarationBase = createBase$A(Node);
...
class Directory {
    ...
    getParent() {
        if (common.FileUtils.isRootDirPath(this.getPath()))
            return undefined;
        return this.addExistingDirectoryIfExists(common.FileUtils.getDirPath(this.getPath()));
    }
    ...
    *_getDescendantDirectoriesIterator() {
    ...
    _emitInternal(options = {}) {
        ...
        const getSubDirPath = (path, dir) => path == null ? undefined : common.FileUtils.pathJoin(path, dir.getBaseName());
...
class DirectoryCoordinator {
    ...
    addSourceFilesAtPaths(fileGlobs, options) {
        if (typeof fileGlobs === "string")
            fileGlobs = [fileGlobs];
        const sourceFiles = [];
        const globbedDirectories = common.FileUtils.getParentMostPaths(fileGlobs.filter(g => !common.FileUtils.isNegatedGlob(g)).map(g => common.FileUtils.getGlobDir(g)));
...
const kindToWrapperMappings = {
    ...
    [common.SyntaxKind.NeverKeyword]: Expression,
...
class CompilerFactory {
    constructor(context) {
        this.context = context;
        this.sourceFileCacheByFilePath = new common.KeyValueCache();
...
class ProjectContext {
    ...
    getPreEmitDiagnostics(sourceFile) {
        const compilerDiagnostics = common.ts.getPreEmitDiagnostics(this.program.compilerObject, sourceFile == null ? undefined : sourceFile.compilerNode);
...
class Project {
    constructor(options = {}) {
        ...
        if (fileSystem != null && options.useVirtualFileSystem)
            ...
            fileSystem = new common.InMemoryFileSystemHost();
        ...
        const tsConfigResolver = options.tsConfigFilePath == null
            ? undefined
            : new common.TsConfigResolver(fileSystemWrapper, options.tsConfigFilePath, getEncoding());
    ...
    addDirectoryAtPathIfExists(dirPath, options = {}) {
        ...
        return this._context.directoryCoordinator.addDirectoryAtPathIfExists(dirPath, Object.assign(Object.assign({}, options), { markInProject: true }));
    }
    addExistingDirectory(dirPath, options = {}) {
        return this.addDirectoryAtPath(dirPath, options);
    }
    addDirectoryAtPath(dirPath, options = {}) {
        dirPath = this._context.fileSystemWrapper.getStandardizedAbsolutePath(dirPath);
        return this._context.directoryCoordinator.addDirectoryAtPath(dirPath, Object.assign(Object.assign({}, options), { markInProject: true }));
    }
    createDirectory(dirPath) {
        dirPath = this._context.fileSystemWrapper.getStandardizedAbsolutePath(dirPath);
    ...
    addSourceFilesFromTsConfig(tsConfigFilePath) {
        ...
        const resolver = new common.TsConfigResolver(this._context.fileSystemWrapper, tsConfigFilePath, this._context.getEncoding());
